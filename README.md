...
O aplicativo está disponível online no domínio [wallet-watching.up.railway.app](https://wallet-watching.up.railway.app/).
...
1. **Instalação Local**:
   ...
   - Configure o banco de dados MySQL: Crie um database chamado `wallet_watching` e importe o schema das tabelas `user`, `transactions` e `wishlist` (disponível no dump fornecido).
...
3. **Uso Online**:
   - Acesse diretamente [wallet-watching.up.railway.app](https://wallet-watching.up.railway.app/).
